...
const services = [
	{
		...
		desc: "Custom enterprise applications and digital solutions.",
	},
	{
		icon: <Phone size={24} />,
		title: "VoIP & Unified Communications",
		desc: "Modern voice and communication infrastructure.",
	},
	{
		icon: <Cloud size={24} />,
		title: "Cloud & DevOps",
		desc: "Scalable cloud solutions and deployment pipelines.",
	},
	{
		icon: <Network size={24} />,
		title: "Networking & Connectivity",
		desc: "Routers, switches, fiber optic, and data center setup.",
	},
	{
		icon: <Zap size={24} />,
		title: "Power Installation",
		desc: "Solar, inverters, generators, and electrical wiring.",
	},
	{
		icon: <Wifi size={24} />,
		title: "ICT Infrastructure",
		desc: "End-to-end infrastructure planning and deployment.",
	},
];
...
const values = [
	{
		...
		desc: "Multidisciplinary engineers across software, telecom, power, and networking bring proven know-how to every project.",
	},
	{
		icon: <Lightbulb size={32} />,
		title: "Innovation-Driven",
		desc: "We stay ahead of technology trends to deliver future-ready solutions that give your organisation a lasting edge.",
	},
	{
		icon: <Clock size={32} />,
		title: "Reliable Delivery",
		desc: "Structured project management and rigorous quality checks ensure on-time, on-budget delivery every time.",
	},
	{
		icon: <ThumbsUp size={32} />,
		title: "Customer First",
		desc: "From consultation to post-deployment support, your satisfaction and operational success drive everything we do.",
	},
];
		...
		<div className="min-h-screen">
			...
			<HeroBackground className="min-h-screen flex items-center justify-center">
				<div className="max-w-5xl mx-auto px-6 py-24 text-center">
					...
					<p className="animate-fade-up delay-300 text-white/70 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
						Sleece Technologies Limited delivers cutting-edge ICT
						infrastructure, power solutions, networking, and security systems —
						end-to-end, built to last.
					</p>
			...
			<section className="py-20 bg-brand-light">
				<div className="max-w-7xl mx-auto px-6">
					<div ref={verticalsRef} className="text-center mb-14">
						<span
							className={`text-brand-green text-sm font-semibold uppercase tracking-widest ${verticalsInView ? "animate-fade-in" : "opacity-0"}`}
						>
							What We Do
						</span>
						<h2
							className={`text-3xl sm:text-4xl font-bold text-brand-blue mt-2 ${verticalsInView ? "animate-fade-up delay-100" : "opacity-0"}`}
						>
							Three Pillars of Excellence
						</h2>
						<p
							className={`text-gray-500 mt-4 max-w-xl mx-auto ${verticalsInView ? "animate-fade-up delay-200" : "opacity-0"}`}
						>
							Our multidisciplinary approach spans technology, power, and
							security — giving you a single trusted partner for all your
			...
			<section className="py-20 bg-white">
				<div className="max-w-7xl mx-auto px-6">
					<div ref={servicesRef} className="text-center mb-14">
						<span
							className={`text-brand-green text-sm font-semibold uppercase tracking-widest ${servicesInView ? "animate-fade-in" : "opacity-0"}`}
						>
							Our Services
						</span>
						<h2
							className={`text-3xl sm:text-4xl font-bold text-brand-blue mt-2 ${servicesInView ? "animate-fade-up delay-100" : "opacity-0"}`}
						>
							End-to-End Solutions
						</h2>
						<p
							className={`text-gray-500 mt-4 max-w-xl mx-auto ${servicesInView ? "animate-fade-up delay-200" : "opacity-0"}`}
						>
					...
					<div
						className={`text-center mt-10 ${servicesInView ? "animate-fade-up delay-600" : "opacity-0"}`}
					>
						<Button
							asChild
							variant="outline"
							className="border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white transition-transform duration-200 hover:scale-105"
						>
							<Link to="/services">
			...
			<section className="py-20 bg-brand-light">
				<div className="max-w-7xl mx-auto px-6">
					<div ref={valuesRef} className="text-center mb-14">
						<span
							className={`text-brand-green text-sm font-semibold uppercase tracking-widest ${valuesInView ? "animate-fade-in" : "opacity-0"}`}
						>
							Why Choose Us
						</span>
						<h2
							className={`text-3xl sm:text-4xl font-bold text-brand-blue mt-2 ${valuesInView ? "animate-fade-up delay-100" : "opacity-0"}`}
						>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
						{values.map(({ icon, title, desc }, i) => (
							...
							>
								...
								<h4 className="font-bold text-brand-blue text-lg mb-2">
									{title}
								</h4>
			...
			<section className="py-20 bg-white">
				<div className="max-w-7xl mx-auto px-6">
					<div ref={testimonialsRef} className="text-center mb-14">
						<span
							className={`text-brand-green text-sm font-semibold uppercase tracking-widest ${testimonialsInView ? "animate-fade-in" : "opacity-0"}`}
						>
							Client Stories
						</span>
						<h2
							className={`text-3xl sm:text-4xl font-bold text-brand-blue mt-2 ${testimonialsInView ? "animate-fade-up delay-100" : "opacity-0"}`}
						>
							What Our Clients Say
						</h2>
						<p
							className={`text-gray-500 mt-4 max-w-xl mx-auto ${testimonialsInView ? "animate-fade-up delay-200" : "opacity-0"}`}
						>
							Trusted by businesses and institutions across Nigeria to deliver
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-7">
						{testimonials.map(
							({ quote, name, title, company, initials }, i) => (
								<div
									key={name}
			...
			<section className="py-20 bg-brand-blue">
				<div ref={ctaRef} className="max-w-3xl mx-auto px-6 text-center">
					<h2
						className={`text-3xl sm:text-4xl font-bold text-white mb-4 ${ctaInView ? "animate-fade-up" : "opacity-0"}`}
					>
						Ready to Transform Your Organisation?
					</h2>
					<p
						className={`text-white/70 text-lg mb-8 ${ctaInView ? "animate-fade-up delay-100" : "opacity-0"}`}
					>
						Let's discuss how Sleece Technologies can help you achieve
						operational excellence, improve connectivity, and accelerate your
						digital journey.
					</p>
					<div
						className={`flex flex-col sm:flex-row gap-4 justify-center ${ctaInView ? "animate-fade-up delay-200" : "opacity-0"}`}
					>
						<Button
							asChild
							size="lg"
